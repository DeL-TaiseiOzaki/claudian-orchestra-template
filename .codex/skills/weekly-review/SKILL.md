---
name: weekly-review
description: Generate a weekly review from the previous week's Daily notes and Wiki changes. Use for weekly retrospectives and planning.
---
...
- 当日（月曜）の `Daily/{YYYY-MM-DD}.md` が無ければ `[[.codex/skills/daily-briefing/SKILL.md]]` 連続実行を提案
