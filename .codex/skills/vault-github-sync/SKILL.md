...
description: Back up the vault to GitHub with a reviewed local-to-remote commit and push. Use for vault commits, pushes, or backup sync.
---
...
| Daily / Weekly | `Daily/` |
| Wiki | `Wiki/` |
| メタ（rules/skills/templates） | `.codex/`, `Templates/` |
