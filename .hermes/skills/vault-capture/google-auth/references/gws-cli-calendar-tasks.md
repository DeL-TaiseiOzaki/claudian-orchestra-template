# GWS CLI OAuth for Calendar + Tasks

Use this when the user explicitly wants Google Workspace CLI (`gws`, https://github.com/googleworkspace/cli) rather than the Hermes Python wrappers.
...
## Authenticate with minimal read-only scopes
...
Use write scopes only after explicit user approval:
...
- Tasks tasklists: `https://tasks.googleapis.com/tasks/v1/users/@me/lists`
- Default task list tasks: `https://tasks.googleapis.com/tasks/v1/lists/%40default/tasks`
